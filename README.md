...
기획/                    # 게임 시스템, 손님 정보, 코드 아키텍처 (통합본) + archive/ (원본 설계안)
```
...
- **게임 시스템**: [`기획/게임 시스템.md`](기획/게임%20시스템.md) — 현재 작동 방식 + 시간대별 콘텐츠(아침/점심/저녁/새벽) + 공포 요소 기획 + SYS-01~12 + 데이터 구조 + 로드맵 (기능정의서·핵심컨셉·위협의 정체·상호작용 미니게임·운영 업무 설계안 통합)
- **손님 정보**: [`기획/손님_정보.md`](기획/손님_정보.md) — 숙박객 카탈로그(컨셉 25 / 완성 9 / 목표 60), 3층 판별 배분, 접객·새벽 대화 골격
- 코드 아키텍처: [`기획/코드-아키텍처.md`](기획/코드-아키텍처.md) — 스크립트 관계도(mermaid ×11)
- 원본 설계안(합치기 전): [`기획/archive/`](기획/archive)
